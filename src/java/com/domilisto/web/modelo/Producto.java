...
public class Producto {
    ...
    private String descripcion;  // Añadido para la descripción
    private double precio;
    private String categoria;  // Añadido para la categoría
    private String imagenUrl;  // Añadido para la URL de la imagen
